...
public class SentaiRangersRecipeProvider extends FabricRecipeProvider {
    ...
    public SentaiRangersRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    private Identifier getStonecuttingIdentifier(Block in, Block out) {
        return SentaiRangers.id(fixupBlockKey(in.getTranslationKey()) + "_to_" + fixupBlockKey(out.getTranslationKey()) + "_stonecutting");
    }
